...
import { Card, Col, Row, Collapse, Modal } from 'react-bootstrap';
...
const ItcView = () => {
    ...
    const handleSubmit = () => {
        ...
        setLoading(true);
        setValidated(true);
        const apiCall = axiosInstance.post('/get-itc-data', ...selectDate );
    ...
    return (
        <>
            <h2 className="mt-2 mb-5">Input Tax Credit</h2>
            <Card className="mb-4">
                <Card.Body>
                    <Row>
                        <Col>
            ...
            <Card>
                ...
                <React.Fragment key={inv.id}>
                    ...
                    <div className="px-2 row">
                        <div className="py-1 col bg-light">
                        ...
                        <div className="py-1 bg-light col">
                        ...
                        <div className="py-1 col bg-light">
                            <h5 className="text-danger">E BRC</h5>
                            {inv.ebrc && (
                                <ul className="list-group list-group-flush">
                                    <li className="list-group-item" style={{ padding: '0.5rem 1rem' }}>
                                    ...
                                    <li className="list-group-item" style={{ padding: '0.5rem 1rem' }}>
                                        <strong>e Brc Date :</strong> {inv.ebrc.e_brc_date}
                                    </li>
                                </ul>
                            )}
                            </div>
