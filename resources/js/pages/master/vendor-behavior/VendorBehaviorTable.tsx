...
import { VendorBehaviorDataType } from './VendorBehavior';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faEdit, faTrash } from '@fortawesome/free-solid-svg-icons';
import swal from 'sweetalert';
import axiosInstance from '../../../axios';

interface VendorBehaviorTableProps {
...
const handleDelete = (userId: number, handleSuccess: () => void) => {
    ...
    .then((willDelete) => {
        if (willDelete) {
            axiosInstance.delete(`/vendor-behavior/${userId}`)
            .then(response => {
...
export const vendorBehaviorTableColumns = ( handleShow: (userId?: number) => void, handleSuccess: () => void): ColumnDef<VendorBehaviorDataType>[] => [
    {
        accessorKey: 'index',
        header: () => {
            return (
...
const VendorBehaviorTable: React.FC<VendorBehaviorTableProps> = ({ handleShow, handleSuccess }) => {
...
export default VendorBehaviorTable;
