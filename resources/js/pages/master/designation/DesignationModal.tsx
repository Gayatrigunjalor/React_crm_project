...
const DesignationModal: React.FC<{ userId?: number; onHide: () => void; onSuccess: () => void }> = ({ userId, onHide, onSuccess }) => {
    ...
    useEffect(() => {
        ...
        if (userId) {
            ...
            axiosInstance.get(`/designation/${userId}`)
            .then(response => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const apiCall = isEditing
            ? axiosInstance.put(`/designation/${custData.id}`,  {
                name: custData.name,
            })
            : axiosInstance.post('/designation', custData);
        ...
        .catch(error => console.error('Error saving designation data:', error));
    };
                    ...
                    <Modal.Body>
                        ...
                        <Form.Group className="mb-3" controlId="formName">
                            ...
                            <Form.Control
                                ...
                                required
                            />
                            <Form.Control.Feedback type="invalid">Please enter designation name.</Form.Control.Feedback>
