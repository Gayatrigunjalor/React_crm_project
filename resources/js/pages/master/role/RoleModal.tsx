...
const RoleModal: React.FC<{ userId?: number; onHide: () => void; onSuccess: () => void }> = ({ userId, onHide, onSuccess }) => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        const apiCall = isEditing
            ? axiosInstance.put(`/role/${custData.id}`,  {
                name: custData.name,
            })
            : axiosInstance.post('/role', custData);
        ...
        .catch(error => console.error('Error saving role data:', error));
    };
