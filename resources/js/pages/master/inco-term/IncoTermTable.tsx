...
import { IncoTermDataType } from './IncoTerm';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faEdit, faTrash } from '@fortawesome/free-solid-svg-icons';
import swal from 'sweetalert';
import axiosInstance from '../../../axios';

interface IncoTermTableProps {
...
const handleDelete = (userId: number, handleSuccess: () => void) => {
    ...
    .then((willDelete) => {
        if (willDelete) {
            axiosInstance.delete(`/inco-terms/${userId}`)
            .then(response => {
...
export const incoTermTableColumns = ( handleShow: (userId?: number) => void, handleSuccess: () => void): ColumnDef<IncoTermDataType>[] => [
    {
        accessorKey: 'index',
        header: () => {
            return (
...
const IncoTermTable: React.FC<IncoTermTableProps> = ({ handleShow, handleSuccess }) => {
