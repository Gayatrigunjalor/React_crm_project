...
import { GstPercentDataType } from './GstPercent';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faEdit, faTrash } from '@fortawesome/free-solid-svg-icons';
import swal from 'sweetalert';
import axiosInstance from '../../../axios';

interface GstPercentTableProps {
...
const handleDelete = (userId: number, handleSuccess: () => void) => {
    ...
    .then((willDelete) => {
        if (willDelete) {
            axiosInstance.delete(`/gst-percent/${userId}`)
            .then(response => {
...
export const gstPercentTableColumns = ( handleShow: (userId?: number) => void, handleSuccess: () => void): ColumnDef<GstPercentDataType>[] => [
    {
        accessorKey: 'index',
        header: () => {
            return (
...
const GstPercentTable: React.FC<GstPercentTableProps> = ({ handleShow, handleSuccess }) => {
...
export default GstPercentTable;
