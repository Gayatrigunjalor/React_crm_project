...
import { VendorTypeDataType } from './VendorType';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faEdit, faTrash } from '@fortawesome/free-solid-svg-icons';
import swal from 'sweetalert';
import axiosInstance from '../../../axios';

interface VendorTypeTableProps {
...
const handleDelete = (userId: number, handleSuccess: () => void) => {
    ...
    .then((willDelete) => {
        if (willDelete) {
            axiosInstance.delete(`/vendorBehaviorListing/${userId}`)
            .then(response => {
...
export const vendorTypeTableColumns = ( handleShow: (userId?: number) => void, handleSuccess: () => void): ColumnDef<VendorTypeDataType>[] => [
    {
        accessorKey: 'index',
        header: () => {
            return (
...
const VendorTypeTable: React.FC<VendorTypeTableProps> = ({ handleShow, handleSuccess }) => {
