...
const BusinessTaskTimeline = () => {
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        setLoading(true);
        setValidated(true);
        const apiCall =  axiosInstance.get('/getBusinessTaskById',{
            params : { business_task_id: timelineForm.business_task_id }
        });
    ...
    return (
        <>
            <Row>
                <Col><h3 className='px-4 mb-4'>Crossroad Connection Chronology</h3></Col>
            </Row>
...
export default BusinessTaskTimeline;
