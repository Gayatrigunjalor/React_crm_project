...
const ProductDoneVsNotdone = ({doneNotDoneCount}) => {
  const leadStats = [
    { type: 'Product Sourcing Done', value: doneNotDoneCount ? doneNotDoneCount.sourcing_done :0, color: '#FF6B6B' },
    { type: 'Product Sourcing Not Done', value: doneNotDoneCount ? doneNotDoneCount.sourcing_not_done:0, color: '#1E90FF' }
  ];
  
  const totalLeads = doneNotDoneCount ? doneNotDoneCount.assigned :0 ;
  
  return (
    <Card className="d-flex shadow-sm border-0 p-4 mt-3 text-center" style={{height: "31rem"}}>
      <h4 >Product Sourcing Done V/S Not Done</h4>
      <div className="d-flex justify-content-center align-items-center" style={{ height: 250 }}>
        ...
        <div style={{
          ...
          {totalLeads}
          <br />
          <p style={{ fontSize: '10px', color: '#555' }}>Product Sourcing Assigned</p>
...
export default ProductDoneVsNotdone;
