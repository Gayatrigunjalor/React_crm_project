...
const productSourcingStats = [
  { type: 'Quotation Send', value: 250, color: '#1E90FF' },
  { type: 'Quotation Not Send', value: 250, color: '#4CAF50' },
  ...
  return (
    ...
    <Card className="d-flex flex-column shadow-sm border-0 p-4 mt-3 align-items-center">
      <Col xs={12} className="d-flex justify-content-between">
         <h4 className="mb-3 text-body-emphasis text-nowrap">Total Qualified Enquiries by Agent</h4>
      </Col>
