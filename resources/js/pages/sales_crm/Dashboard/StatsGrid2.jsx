...
const StatsGrid2 = ({ teamStatsData }) => {
  console.log("teamStatsData", teamStatsData);
  
  const stats = [
    {
      title: "Total Customers",
      count: teamStatsData?.total_customers ||0,
      icon: FaUserFriends,
      iconColor: "#F29993",
      borderColor: "#F29993",
    },
    {
      ...
      count: teamStatsData?.total_inquiries ||0,
...
,    
    {
      ...
      count: teamStatsData?.total_software_qualified ||0,
      icon: FaCheckSquare,
      iconColor: "#FFC000",
      borderColor: "#FFC000",
    },
    {
      ...
      count:  teamStatsData?.total_agent_qualified ||0,
      icon: FaUser,
      iconColor: "#3FB65F",
      borderColor: "#3FB65F",
    },
