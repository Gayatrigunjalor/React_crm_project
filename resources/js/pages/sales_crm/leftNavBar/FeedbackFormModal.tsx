...
const FeedbackModal = () => {
    ...
    return (
        <Container className="p-5 mt-4 d-flex justify-content-center">
            <div
                className="p-5 w-100"
                style={{
                    maxWidth: "900px",
            ...
            >
                <h3 className="text-center mb-5 fw-bold" style={{ fontSize: "24px" }}>
                    Give Your Feedback
                </h3>
                                        ...
                                        {index === 1 || index === 4 ? (
                                            ...
                                            <Form.Control
                                                ...
                                                className={`mt-2 p-2 border rounded ${
                                                    missingFields.includes("delayDescription") ? "border-danger" : ""
                                                }`}
                                            ...
                                            <div
                                                className={`d-flex justify-content-start gap-3 flex-wrap mt-2 ${
