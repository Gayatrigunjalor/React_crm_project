...
import DocumentDropdown from "../inquiryRecived/Documentdrop";
      ...
      `}</style>
            ...
            <div className="form-container">
                ...
                <Row>
                    <Col md={6}>
                        <div className="compact-field">
                            <label className="compact-label">Customer ID::</label>
                    ...
                    <Col md={6}>
                        <div className="compact-field">
                            <label className="compact-label">Customer Status::</label>
                            <div className="input-wrapper">
                                <Form.Control type="text" className="input-field" />
                                <img src={EditIcon} alt="Edit" className="form-icon" />
                            </div>
                ...
                <Row>
                    <Col md={6}>
                        <div className="compact-field">
                            <label className="compact-label">Country Status:</label>
                            <div className="input-wrapper">
                                <Form.Control type="text" className="input-field" />
                                <img src={EditIcon} alt="Edit" className="form-icon" />
                            </div>
                ...
                <Row>
                    <Col md={6}>
                        <div className="compact-field">
                            <label className="compact-label">Customer Name:</label>
                            <div className="input-wrapper">
                                <Form.Control type="text" className="input-field" />
                                <img src={EditIcon} alt="Edit" className="form-icon" />
                            </div>
                ...
                <Row>
                    <Col md={6}>
                        <div className="compact-field">
                            <label className="compact-label">Sender Address:</label>
                            <div className="input-wrapper">
                                <Form.Control type="text" className="input-field" />
                                <img src={EditIcon} alt="Edit" className="form-icon" />
                            </div>
                    ...
                    <Col md={6}>
                        <div className="compact-field">
                            <label className="compact-label">Country Coder:</label>
                            <div className="input-wrapper">
                                <Form.Control type="text" className="input-field" />
                                <img src={EditIcon} alt="Edit" className="form-icon" />
                            </div>
                ...
                <Row>
                    <Col md={6}>
                        <div className="compact-field">
                            <label className="compact-label">Industry Sector:</label>
                            <div className="input-wrapper">
                                <Form.Control type="text" className="input-field" />
                                <img src={EditIcon} alt="Edit" className="form-icon" />
                            </div>
