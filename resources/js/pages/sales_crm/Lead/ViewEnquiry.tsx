...
const ViewEnquiry = () => {
    ...
    const columns: ColumnDef<Lead>[] = [
        ...
        },
        {
            ...
            meta: {
                headerProps: {
                    style: { fontFamily: 'Nunito Sans, sans-serif', fontWeight: '700', width: '150px' }
                },
                cellProps: { style: { fontFamily: 'Nunito Sans, sans-serif' } },
            },
        },
    ...
    useEffect(() => {
        const fetchEnquiryDetails = async () => {
            ...
            try {
                const response = await axiosInstance.post('/customer_list_lead', body,
                    {
                        headers: {
    ...
    const handleRowClick = (leadId: number, customerId: number,unique_query_id:number) => {
    ...
    return (
        ...
        <AdvanceTableProvider {...table}>
            <div className="d-flex justify-content-between mb-4">
                <h3 className="mt-4" style={{ fontFamily: 'Nunito Sans, sans-serif', fontWeight: '700' }}>Enquiry details</h3>
