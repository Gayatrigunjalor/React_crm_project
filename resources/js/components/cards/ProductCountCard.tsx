...
import ProductCountTopChart from '../charts/e-charts/ProductCountTopChart';
import { Card } from 'react-bootstrap';

const  ProductCountCard = () => {
 
  const [count, setTotalProductCount] = useState(0);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setTotalProductCount(results[0]);
  ...
  return (
    <Card className="h-100">
      <Card.Body>
        ...
        <ProductCountTopChart totalCount={count}  />
        </div>
        <div>
