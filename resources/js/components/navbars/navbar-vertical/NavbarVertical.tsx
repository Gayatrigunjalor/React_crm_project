...
import { RouteItems } from '../../../sitemap';

const NavbarVerical = () => {
  const [filteredRoutes, setFilteredRoutes] = useState<RouteItems[]>([]);
    ...
    <NavbarVerticalCollapseProvider>
      ...
      >
        ...
        <div className="navbar-vertical-footer">
          ...
          >
            {isNavbarVerticalCollapsed ? (
              <FontAwesomeIcon icon={faLongArrowRight} size='lg' className="me-2" />
            ) : (
              <>
                <FontAwesomeIcon icon={faLongArrowLeft} size='lg' className="me-2" />
