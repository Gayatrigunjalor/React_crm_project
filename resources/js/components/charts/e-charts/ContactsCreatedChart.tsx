...
const getDefaultOptions = (getThemeColor: (name: string) => string) => ({
  ...
  //   },
  //   show: true,
  //   data: dates,  // Ensure this is an array with values
  //   axisLine: {
  //     lineStyle: {
  //       color: getThemeColor('tertiary-bg')
  //     }
...
const ContactsCreatedChart = ({ style }: { style: CSSProperties }) => {
  ...
  const options = getDefaultOptions(getThemeColor);
  console.log("Chart Options:", options); // Debugging
  return (
    <ReactEChartsCore
      echarts={echarts}
